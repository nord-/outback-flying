...
export interface Region {
  ...
  // Tail number template: 'L' = random letter, 'D' = random digit, any other
  // character passes through literally (e.g. 'VH-LLL' -> 'VH-ABC').
