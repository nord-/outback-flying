...
export type Suitability = 'ok' | 'marginal' | 'short'
...
/** Available runway over what the aircraft needs. 1.0 = exactly enough. */
 ...
 * anything — the UI warns, the player decides (B2/B3).
 */
